...
// The kind-9999 item id is STILL in the notes track — that pollution is OPEN 296, a
...
test('R8 (E1, additivity): building the items track leaves members / fullMembers / total / truncated byte-identical', async () => {
  ...
  assert(out.total === 4, `total must still be 4 (kind-9999 ids still present — OPEN 296 left alone); got ${out.total}`);

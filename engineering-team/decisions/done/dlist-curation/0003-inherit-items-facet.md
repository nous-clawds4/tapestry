...
> **Superseded in part (2026-09-12):** the consequence "Enables story 4" — the spec's curated header links with `"pointer"` and holds curation copies; the facet itself stands, and the header endpoint stops emitting it in `curated-dlist-update` story 2 — `engineering-team/decisions/done/curated-dlist-update/0001-curation-copy-convention.md`.

...
- **Know the stack and environment.** Node.js + Neo4j + strfry; Concept Graph API at `localhost:$TAPESTRY_PORT` (port per AGENTS.md §1); firmware-driven concept definitions; Playwright-driven UI tests.

...
3. **Count-vs-list divergence.** Profile verified-followers count (Meili-precomputed) vs followers-table length (live Neo4j) diverge (Jack 26,711 vs 22,981) — cutoff + staleness. Reconcile with item 2. **Priority: low-medium.**

...
- **Baseline:** — *(→ the `origin/staging` SHA at arming. No stories, ADRs, or source changes for the `live-feed` epic may exist at that SHA — pre-existing work voids the run)*

...
- [ ] **The protocol says "copy".** The spec states how my assistant copies a community item into my
...
- [ ] **Headers and words agree.** My assistant's header links to the shared list as a `pointer`; a
...
- [ ] **Another assistant's curation opens read-only.** A list my Treasure Map empowers for an
...
- [ ] **The curation method.** The Curation method panel shows the Scoring Method and point of view I
...
- [ ] **Update list works, with a preview.** Pressing Update list shows what my assistant would do —
...
- [ ] **Safe by default.** A failed or incomplete read never proposes a deletion. Nothing runs on a

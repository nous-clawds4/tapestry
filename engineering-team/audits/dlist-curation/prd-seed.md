...
**Confidence:** medium — the as-built is high-confidence, and the frame came from a long design conversation with the operator, but the product framing below is inferred from one operator's intent (Bob on Alice's instance preparing his own firmware) and has been exercised by one user only — the operator's real-signer Add of `dog-breed` on staging, 2026-09-10 (audit §5); no second user yet
**Date:** 2026-09-10

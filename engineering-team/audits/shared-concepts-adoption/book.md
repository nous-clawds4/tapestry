...
- [ ] **F5 — concept-header b-coverage audit + guided disposition**: coverage tracking on Concept Headers plus the owner-prompted disposition flow (wire to external / self-declare / deliberately private — the marker form is W16's ruling).

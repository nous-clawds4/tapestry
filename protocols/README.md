...
| Tapestry Assistant Designation & Dual-Author Header Resolution (companion to NIP-85) + per-DList curation entries | [drafts/assistant-designation.md](./drafts/assistant-designation.md) | 📝 pre-NIP | **Working copy here** (BIBLE §953 Assistant Keys holds the pointer) | `community-reference` #35 · `dlist-curation` #2 |

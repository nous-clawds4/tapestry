...
**Refs:** [stamping spec](./drafts/stamping.md) § "Open: which layers to stamp"; [class-thread-relationships spec](./drafts/class-thread-relationships.md); `docs/NIP_REORG_DESIGN_HANDOFF.md` O1; `nip-reorg` ADR 0003.

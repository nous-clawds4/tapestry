...
**Worked example.** Alice publishes an item into *Widgets for Carpenters* (⊂ *Widgets*). Under the write rule above she stamps her personal `z` plus Widgets-for-Carpenters cloud handles. Open: does the item also stamp *Widgets*-layer handles — and which branches of them?

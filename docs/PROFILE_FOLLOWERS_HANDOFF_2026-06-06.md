...
2. **Count-vs-list divergence.** The profile count (Meili-precomputed, House suffix) read **26,711** for Jack while the live table query returned **22,981** — different effective cutoff + staleness. Expected per ADR/review, but worth reconciling with #3.

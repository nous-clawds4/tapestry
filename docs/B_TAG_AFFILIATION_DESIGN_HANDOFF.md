...
**Scope clarification (2026-06-12, raised by the LFO-membership scenario).** D1 governs **structural containment** — an item's `z` to its parent list. It does *not* mean community-directed assertions avoid shared handles. A kind-39999 tagging ("Alice is a member of LFO") carries two distinct concept references with different rules:

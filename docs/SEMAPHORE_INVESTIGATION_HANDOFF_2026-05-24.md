...
2. **The full evidence + architectural context is in [`engineering-team/decisions/task-queue-scheduler/0023-task-queue-semaphore-protection-audit.md`](../engineering-team/decisions/task-queue-scheduler/0023-task-queue-semaphore-protection-audit.md)** — specifically the section titled "**2026-05-24 amendment (later) — chosen mechanism is functionally moot; story #26 paused pending root-cause investigation**". Read this for the empirical PID-by-PID evidence table, candidate hypotheses, and impact on past work (PR #201 + story #26).

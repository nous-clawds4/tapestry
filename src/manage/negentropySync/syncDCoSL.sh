...
chown brainstorm:brainstorm ${BRAINSTORM_LOG_DIR}/syncDCoSL.log
...
strfry sync wss://dcosl.brainstorm.world --filter "$FILTER1" --dir both

strfry sync wss://relay.damus.io --filter "$FILTER2" --dir down

...
// getMutesForRater() is acceptable at mutes' bounded scale (~190k authors).
...
async function main() {
  try {
    ...
    // Process raters in batches (per-author N+1 getMutesForRater is fine at mutes' bounded scale).

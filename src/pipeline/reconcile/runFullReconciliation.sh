...
chown brainstorm:brainstorm ${BRAINSTORM_LOG_DIR}/runFullReconciliation.log
...
node ${BRAINSTORM_MODULE_PIPELINE_DIR}/reconcile/createReconciliationQueue.js
...
node ${BRAINSTORM_MODULE_PIPELINE_DIR}/reconcile/processReconciliationQueue.js

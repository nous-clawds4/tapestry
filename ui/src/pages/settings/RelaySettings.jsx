...
const RELAY_GROUPS = [
  ...
  { key: 'aTapestryInstanceRelays', label: 'Tapestry Instance Relays', hint: 'Peer Tapestry / Brainstorm instances. Checked when reporting which relays hold your Treasure Map.', restart: false },

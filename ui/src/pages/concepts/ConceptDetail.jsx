          ...
          <div className="concept-actions">
            ...
            <button
              ...
              title={alreadyShared
                ...
                : "Re-sign this concept's header with a self-pointing pointer-b tag and publish that one event to the community relay. It will then be listed under Shared by me, and under Shared with the community on every instance that can see it."}
            >
              {declaring
                ? 'Submitting…'
